...
@Component({
  ...
  exportAs: 'carousel',
  template: `
  <button mat-icon-button (click)="prev()" class="btn btn-default control"><mat-icon>arrow_back</mat-icon></button>
    ...
    <button mat-icon-button (click)="next()" class="btn btn-default control"><mat-icon>arrow_forward</mat-icon></button>
  `,
  styles: [`
    ul {
      list-style: none;
